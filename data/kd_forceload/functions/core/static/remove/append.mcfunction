#> kd_forceload:core/static/remove/append
# 
# 実行チャンクがすでに読み込まれていた場合にチャンクリストに追加する
# 
# @internal
...
# scannedにチャンクを追加
data modify storage kd_forceload:core chunks[{active:1b}].scanned append from storage kd_forceload:core _.I